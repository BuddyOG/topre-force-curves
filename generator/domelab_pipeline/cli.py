...
def main(argv=None):
    ...
    ap.add_argument(
        "--viewer-profile", choices=("review", "release"), default="review",
        help="viewer presentation identity; scientific inputs are identical (default: review)",
    )
    ...
    kw = dict(viewer_html=a.viewer_html, picker_html=a.picker_html,
              ...
              evidence_only=a.evidence_only, viewer_profile=a.viewer_profile)
    if a.check:
