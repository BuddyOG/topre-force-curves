...
CACHE = WORK_ROOT / "raw_cache" / f"repo-{COMMIT}"
STAGING = WORK_ROOT / "epoch_outputs" / "staging_canonical_6e86ac19"
WORKBOOK = WORK_ROOT / "epoch_inputs" / "source_workbook" / "untested-domes_v2.xlsx"
...
def test_epoch_input_reseal_is_deterministic_and_rejects_tampering(tmp_path):
    ...
    shutil.copytree(WORK_ROOT / "epoch_inputs", isolated / "epoch_inputs")
    shutil.copytree(
        WORK_ROOT / "source" / "generator" / "domelab_pipeline" / "config",
